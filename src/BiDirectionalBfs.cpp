        ...
        if(do_start){
            ...
            for(auto e:possible_flips){
                ...
                if((x_2==_closed_from_start.end())){
                    _queue_from_start.push(std::pair<std::vector<int16_t>,int>(_triangulation_from_start.get_representation(),distance));
            ...
            for(auto e:possible_flips){
                ...
                if(x_2==_closed_from_target.end()){
                    _queue_from_target.push(std::pair<std::vector<int16_t>,int>(_triangulation_from_target.get_representation(),distance));
