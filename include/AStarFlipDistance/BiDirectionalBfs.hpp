...
private:
    std::unordered_map<std::vector<int16_t>,int,Hasher,EqualFn> _closed_from_start;
    std::unordered_map<std::vector<int16_t>,int,Hasher,EqualFn> _closed_from_target;
    std::queue<std::pair<std::vector<int16_t>,int>> _queue_from_start;
    std::queue<std::pair<std::vector<int16_t>,int>> _queue_from_target;
